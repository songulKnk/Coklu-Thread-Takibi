...
public class CokluThreadTakip {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Thread 1 olusturuldu." + "\nThread 2 olusturuldu." + "\nThread 3 olusturuldu.");
		...
		while(sinyal!=0) {
			...
			if(!t1.isAlive() && t1Gulegule==false) {
				System.out.println("Thread 1! Yolun açık olsun.");
				t1Gulegule=true;
				sinyal--;
			}
			else if(!t2.isAlive() && t2Gulegule==false) {
				System.out.println("Thread 2! Yolun açık olsun.");
				t2Gulegule=true;
				sinyal--;
			}
			else if(!t3.isAlive() && t3Gulegule==false) {
				System.out.println("Thread 3! Yolun açık olsun.");
				t3Gulegule=true;
				sinyal--;
			}
		}
